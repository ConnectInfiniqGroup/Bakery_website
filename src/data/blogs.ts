export const blogs = [
  {
    ...
    date: 'May 12, 2024',
    image: '/assets/blog_image_1_1782077550281.png',
    category: 'Tips & Tricks',
    content: 'Baking perfect bread is both an art and a science. It requires patience, precise measurements, and understanding how yeast behaves in different environments.\n\nIn this guide, we cover everything from selecting the right flour to understanding the importance of kneading and proofing. The secret to a perfect crust lies in the steam during the first few minutes of baking. Remember, great bread takes time, so don\'t rush the fermentation process. Happy baking!'
  },
  {
    id: 2,
    title: 'Celebrating 40 Years of Sweet Memories',
    date: 'March 18, 2024',
